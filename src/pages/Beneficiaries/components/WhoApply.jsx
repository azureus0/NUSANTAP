  ...
  return (
    <section className="flex flex-col min-h-[70vh]">
      ...
      <div className="hidden md:flex justify-center items-center py-8">
        <h1 className="text-3xl font-bold font-Playfair">Who Can Apply?</h1>
      </div>

      {/* Bagian tengah */}
      <div className="bg-[#474747] w-full p-16 md:py-0">
        <h1 className="flex md:hidden text-3xl font-bold text-[#fff] justify-center items-center font-Playfair">Who Can Apply?</h1>
